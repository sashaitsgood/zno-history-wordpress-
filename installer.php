...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20241217_zno_0e3e0eeb326425269190_20241217175047_archive.zip';
        const ARCHIVE_SIZE       = '34931639';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '0e3e0ee-17175047';
        const SECONDARY_PACKAGE_HASH = '8cd2184-17175047';
